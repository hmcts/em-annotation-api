...
class FilterAnnotationSetIntTest  extends BaseTest {

    private final AnnotationSetMapper annotationSetMapper;
    private static final String URI_TEMPLATE = "/api/annotation-sets/filter?documentId=Test";
    ...
    @Autowired
    public FilterAnnotationSetIntTest(AnnotationSetRepository annotationSetRepository,
                                      AnnotationSetMapper annotationSetMapper, EntityManager em) {
    ...
    void testGetAllAnnotationSets() throws Exception {
        ...
        restLogoutMockMvc.perform(get(URI_TEMPLATE)
