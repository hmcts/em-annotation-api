...
public class IdamConsumerTest {
    ...
    public static final String EMAIL_VALUE = "emCaseOfficer@email.net";
    public static final String PASSWORD_VALUE = "Password123";
    ...
    public void shouldPostToTokenEndpointAndReceiveAccessTokenWith200Response(MockServer mockServer)
        ...
        String actualResponseBody =
                SerenityRest
                        ...
                        .formParam("username", EMAIL_VALUE)
    ...
    public RequestResponsePact executeGetUserDetailsAndGet200(PactDslWithProvider builder) {
        ...
        params.put("username", EMAIL_VALUE);
        params.put(PASSWORD, PASSWORD_VALUE);
